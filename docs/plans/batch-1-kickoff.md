...
> 2026-04-15 · 周 1 · M0 通过后启动 · 约 1-2 天完成
...
| 任务 | 乐观 | 悲观 | 主要风险 |
|---|---|---|---|
| T0.4 LocalEngine 骨架 | 2h | 5h | Protocol 有模糊处需要回 T0.1 澄清 |
| T0.5 WS gateway 骨架 | 3h | 6h | schema 某些消息类型边界不清 |
| T0.6 前端 monorepo | 4h | 10h | 技术选型决策延迟、依赖安装问题 |
| 联调 § 5 | 1h | 3h | CORS / 端口 / schema 细节 |
| **合计** | **10h** | **24h** | 应在 2 天内完成 |

*AI 实际耗时可能远低于此；但人类 review 和决策窗口是实际瓶颈。*
